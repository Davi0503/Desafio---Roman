...
- 4 **[Aplicativo](#Aplicativo)**  
 - 4.1. **[Prototipação](#Prototipação)**  
 - 4.2. **[Inicialização](#Aplicativo)**  
   - 4.2.1 **[Android SDK](#Android-SDK)**  
   - 4.2.2 **[React Native Modules](#React-Native-Modules)**  
 - 4.3. **[Telas](#Telas)**  
...
### Inicialização  
Se você não quiser ocupar espaço no seu celular para testar a aplicação, você deve instalar o android studio ou alguma AVD ae, mas ... eu não sei... vou só ensinar como fazer isso usando o Android Studio.  
é algo simples:  
*  Vá clicando em **Next** até chegar na parte de instalação.  
*  Selecione **Custom Instalation**  
*  Selecione todos os campos  
*  Instale tudo (vai demorar um pouco, faça um café e relaxe um pouco)  
